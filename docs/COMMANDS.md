...
trinity init --no-ai-attribution  # Add rule to remove AI attribution from commits/code
...
| `--no-ai-attribution` | Add rule preventing "Generated by Claude", "Co-Authored-By: Claude", etc. |
