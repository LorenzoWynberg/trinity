...
export const VersionNode = memo(({ data }: NodeProps) => {
  ...
  return (
    <>
      ...
      >
        <div className={cn('font-bold text-lg text-purple-800 dark:text-purple-100 cyber-dark:text-cyan-100', isVertical && 'text-center')}>
          {nodeData.label}
        </div>
        {nodeData.title && (
        ...
        <div className={cn('mt-2 text-sm text-purple-600 dark:text-purple-300 cyber-dark:text-cyan-200', isVertical && 'text-center')}>
