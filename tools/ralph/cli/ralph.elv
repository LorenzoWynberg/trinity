...
claude:init $project-root $script-dir $prompt-template $config[claude-timeout] $config[quiet-mode] $config[max-iterations] &auto-dup=$config[auto-duplicate] &auto-rev-deps=$config[auto-reverse-deps]
